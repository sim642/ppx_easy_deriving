...
module Unit : Easy_equal =
  struct
    ...
    include
      struct
        let rec (easy_equal : t -> t -> bool) = fun () -> fun () -> true
          [@@ocaml.warning "-39"]
        let rec (easy_equal2 : t -> t -> bool) = fun () -> fun () -> true
          [@@ocaml.warning "-39"]
      end[@@ocaml.doc "@inline"][@@merlin.hide ]
  end 
let _ = fun () -> fun () -> true
            ...
            fun r ->
              (fun (l1, l2) ->
                 fun (r1, r2) ->
                   (__0 l1 r1) &&
                     ((fun (l1, l2) ->
                         fun (r1, r2) -> (__1 l1 r1) && (__2 l2 r2)) l2 r2))
                ((fun (f1, f2, f3) -> (f1, (f2, f3))) l)
                ((fun (f1, f2, f3) -> (f1, (f2, f3))) r)[@@ocaml.warning
                                                          "-39"]
      end[@@ocaml.doc "@inline"][@@merlin.hide ]
  end 
          ...
          fun l ->
            fun r ->
              (fun (l1, l2) -> fun (r1, r2) -> (__0 l1 r1) && (__1 l2 r2))
                ((fun { f1; f2 } -> (f1, f2)) l)
                ((fun { f1; f2 } -> (f1, f2)) r)[@@ocaml.warning "-39"]
      end[@@ocaml.doc "@inline"][@@merlin.hide ]
  end 
            ...
            fun r ->
              (fun l ->
                ...
                ((function
                  ...
                  | C4 f1 -> Either.Right (Either.Right (Either.Right f1))) l)
                ((function
                  | C1 -> Either.Left ()
                  | C2 (f1, f2) -> Either.Right (Either.Left (f1, f2))
                  | C3 { f1; f2 } ->
                      Either.Right (Either.Right (Either.Left (f1, f2)))
                  | C4 f1 -> Either.Right (Either.Right (Either.Right f1))) r)
          [@@ocaml.warning "-39"]
      end[@@ocaml.doc "@inline"][@@merlin.hide ]
  end
            ...
            fun r ->
              (fun l ->
                   ...
                   | (Either.Right l, Either.Right r) ->
                       ((fun l ->
                           fun r ->
                             ...
                             | (Either.Right l, Either.Right r) -> __2 l r
                             | (_, _) -> false)) l r
                   | (_, _) -> false)
                ((function
                  | `C1 -> Either.Left ()
                ...
                ((function
                  | `C1 -> Either.Left ()
                  | `C2 f -> Either.Right (Either.Left f)
                  | `C4 f -> Either.Right (Either.Right f)) r)[@@ocaml.warning
                                                                "-39"]
      end[@@ocaml.doc "@inline"][@@merlin.hide ]
  end
            ...
            fun r ->
              (fun l ->
                   ...
                   | (Either.Right l, Either.Right r) ->
                       ((fun l ->
                           fun r ->
                             ...
                             | (Either.Left l, Either.Left r) ->
                                 ((fun () -> fun () -> true)) l r
                             | (Either.Right l, Either.Right r) -> __1 l r
                             | (_, _) -> false)) l r
                   | (_, _) -> false)
                ((function
                ...
                ((function
                  | #PV.t as f -> Either.Left f
                  | `C5 -> Either.Right (Either.Left ())
                  | #u as f -> Either.Right (Either.Right f)) r)[@@ocaml.warning
                                                                  "-39"]
      end[@@ocaml.doc "@inline"][@@merlin.hide ]
  end
